...
示例代码以 C++17 为标准，并按照学校视频统一使用竞赛中常见的 `#include <bits/stdc++.h>`。该头文件通常由 GCC 编译器提供；如果本地软件提示找不到它，需要改用学校指定的 GCC 环境，或按需换成 `<iostream>`、`<string>`、`<iomanip>` 等标准头文件。

当前仓库暂未指定开源许可；如需转载、改编或用于商业课程，请先联系仓库作者。
